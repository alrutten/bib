	...
	s = function (input, returnData = FALSE) {
	  x = c(10, 17, 21, 26, 29, 32, 36, 38, 50, 63, 67, 68, 72, 85, 106, 109, 117, 121, 122, 123, 125,128, 131, 137, 138, 
	        140, 152, 156, 161, 167, 177, 178, 179, 183, 198, 214, 218, 219, 225,230, 249, 256, 261, 263, 265, 269)
